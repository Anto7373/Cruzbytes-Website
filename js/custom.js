/*
   Template Name: Botato - Finance, Consulting, Business HTML Template
   Author: ka_boldbaatar
   Author URI: https://themeforest.net/user/ka_boldbaatar
   Description: Botato - Finance, Consulting, Business HTML Template
   Version: 1.0
        ...
        if (wWidth > 974) {
            if ($('#header, #header-2 .site-nav-inner').length) {
                ...
                if (scroll >= 400) {
                    ...
                    $(".logocss").attr("src", "images/custom/logo.png");
                } else {
                    sticky.removeClass('fixed');
                    $(".logocss").attr("src", "images/custom/logo-white.png");
                }
